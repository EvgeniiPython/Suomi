---
title: Session 2026-09-02
record_schema: canonical-v2
session_type: FULL_LESSON
---

# Speaking-First Lesson — 02.09.2026

## Lesson
Date: 2026-09-02

## Primary Can-Do
Самостоятельно использовать профессиональные конструкции `minun täytyy + infinitive`, `lähetän / lähden`, `en lähetä / lähetän`, `sähköpostia / sähköpostin`, `lounaan jälkeen / ennen lounasta`, `saada + objekti + valmiiksi`, `pyytää + henkilö + -maan/-mään` и `jos en ehdi...` в новых рабочих ситуациях.
...
## Выполнено
- Blind retrieval пяти профессиональных предложений.
- Repair и variation для `sähköpostia / sähköpostin`.
...
decision: KEEP
reason: Correct independent transfer and final recall after repair.
next_action: Continue delayed changed-context recall.

candidate: `pyytää + henkilö + -maan/-mään`
decision: KEEP
reason: Independent production remained reliable.
...
decision: KEEP
reason: Contrast was repeatedly practiced and improved, but remains active-watch.
...
decision: DEFER
reason: Existing priority patterns remain consolidating or active-watch.
...
cause: contrast selection, object/reference form selection, and processing/spelling load.
next_action: Delayed recall and unlabeled mixed-choice.

### Next Step
next_action: Continue delayed recall; prioritize `sähköpostia / sähköpostin`, `se/ne/niitä`, `lähetän / lähden`, and `saada + objekti + valmiiksi`. Keep new chunks deferred until stable recall + variation + transfer.
