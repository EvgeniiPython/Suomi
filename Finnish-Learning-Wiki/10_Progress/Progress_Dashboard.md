...
## Наблюдение
14.08 recall и понимание выглядят устойчиво, а беглость немного улучшилась. Пользователь самостоятельно использовал причину и предложение нового времени в короткой вариации. При этом `tapaamiseen` и `samaan aikaan` ещё требуют автоматизации под нагрузкой.
